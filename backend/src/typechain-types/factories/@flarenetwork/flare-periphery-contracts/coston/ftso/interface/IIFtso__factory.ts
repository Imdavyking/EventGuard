...
import type {
  IIFtso,
  IIFtsoInterface,
} from "../../../../../../@flarenetwork/flare-periphery-contracts/coston/ftso/interface/IIFtso";
...
export class IIFtso__factory {
  ...
  static createInterface(): IIFtsoInterface {
    return new Interface(_abi) as IIFtsoInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IIFtso {
    return new Contract(address, _abi, runner) as unknown as IIFtso;
  }
}
