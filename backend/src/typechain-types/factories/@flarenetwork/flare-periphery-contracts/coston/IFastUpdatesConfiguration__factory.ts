...
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IFastUpdatesConfiguration";
...
export class IFastUpdatesConfiguration__factory {
  ...
  static createInterface(): IFastUpdatesConfigurationInterface {
    return new Interface(_abi) as IFastUpdatesConfigurationInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IFastUpdatesConfiguration;
  }
}
