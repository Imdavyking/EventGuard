...
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IEntityManager";
...
export class IEntityManager__factory {
  ...
  static createInterface(): IEntityManagerInterface {
    return new Interface(_abi) as IEntityManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IEntityManager {
    return new Contract(address, _abi, runner) as unknown as IEntityManager;
  }
}
