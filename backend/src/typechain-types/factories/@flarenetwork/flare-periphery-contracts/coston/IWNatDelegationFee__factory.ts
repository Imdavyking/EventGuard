...
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IWNatDelegationFee";
...
export class IWNatDelegationFee__factory {
  ...
  static createInterface(): IWNatDelegationFeeInterface {
    return new Interface(_abi) as IWNatDelegationFeeInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IWNatDelegationFee {
    return new Contract(address, _abi, runner) as unknown as IWNatDelegationFee;
  }
}
