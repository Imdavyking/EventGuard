...
import type {
  IIVPToken,
  IIVPTokenInterface,
} from "../../../../../../@flarenetwork/flare-periphery-contracts/coston/token/interface/IIVPToken";
...
export class IIVPToken__factory {
  ...
  static createInterface(): IIVPTokenInterface {
    return new Interface(_abi) as IIVPTokenInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IIVPToken {
    return new Contract(address, _abi, runner) as unknown as IIVPToken;
  }
}
