...
} from "../../../../../../@flarenetwork/flare-periphery-contracts/coston/token/interface/IIGovernanceVotePower";
...
export class IIGovernanceVotePower__factory {
  ...
  static createInterface(): IIGovernanceVotePowerInterface {
    return new Interface(_abi) as IIGovernanceVotePowerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IIGovernanceVotePower;
  }
}
