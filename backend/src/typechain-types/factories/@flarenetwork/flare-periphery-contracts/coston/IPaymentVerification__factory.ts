...
import type {
  ...
  IPaymentVerificationInterface,
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IPaymentVerification";
...
export class IPaymentVerification__factory {
  static readonly abi = _abi;
  static createInterface(): IPaymentVerificationInterface {
    return new Interface(_abi) as IPaymentVerificationInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IPaymentVerification;
  }
}
