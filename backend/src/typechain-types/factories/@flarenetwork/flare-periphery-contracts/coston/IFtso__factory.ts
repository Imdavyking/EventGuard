...
import type {
  IFtso,
  IFtsoInterface,
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IFtso";
...
export class IFtso__factory {
  ...
  static createInterface(): IFtsoInterface {
    return new Interface(_abi) as IFtsoInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IFtso {
    return new Contract(address, _abi, runner) as unknown as IFtso;
  }
}
