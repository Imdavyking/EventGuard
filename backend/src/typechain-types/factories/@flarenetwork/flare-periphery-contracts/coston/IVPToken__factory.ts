...
import type {
  IVPToken,
  IVPTokenInterface,
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IVPToken";
...
export class IVPToken__factory {
  ...
  static createInterface(): IVPTokenInterface {
    return new Interface(_abi) as IVPTokenInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IVPToken {
    return new Contract(address, _abi, runner) as unknown as IVPToken;
  }
}
