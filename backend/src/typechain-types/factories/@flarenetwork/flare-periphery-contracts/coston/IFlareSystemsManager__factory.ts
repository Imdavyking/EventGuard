...
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IFlareSystemsManager";
...
export class IFlareSystemsManager__factory {
  ...
  static createInterface(): IFlareSystemsManagerInterface {
    return new Interface(_abi) as IFlareSystemsManagerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IFlareSystemsManager;
  }
}
