...
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IFastUpdateIncentiveManager";
...
export class IFastUpdateIncentiveManager__factory {
  ...
  static createInterface(): IFastUpdateIncentiveManagerInterface {
    return new Interface(_abi) as IFastUpdateIncentiveManagerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IFastUpdateIncentiveManager;
  }
}
