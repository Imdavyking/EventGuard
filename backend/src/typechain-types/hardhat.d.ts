...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "IStarWarsCharacterList",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.IStarWarsCharacterList__factory>;
    getContractFactory(
      name: "StarWarsCharacterList",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.StarWarsCharacterList__factory>;
    getContractFactory(
      name: "Helpers",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ...
    getContractAt(
      ...
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.IStarWarsCharacterList>;
    getContractAt(
      name: "StarWarsCharacterList",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.StarWarsCharacterList>;
    getContractAt(
      name: "Helpers",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
