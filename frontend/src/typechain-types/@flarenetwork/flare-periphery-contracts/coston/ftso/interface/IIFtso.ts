...
export namespace PriceHashSubmittedEvent {
  export type InputTuple = [
...
export interface IIFtso extends BaseContract {
  ...
  submitPriceHashSubmitter: TypedContractMethod<
    [_sender: AddressLike, _epochId: BigNumberish, _hash: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "submitPriceHashSubmitter"
  ): TypedContractMethod<
    [_sender: AddressLike, _epochId: BigNumberish, _hash: BytesLike],
    [void],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "PriceHashSubmitted"
  ): TypedContractEvent<
    PriceHashSubmittedEvent.InputTuple,
    PriceHashSubmittedEvent.OutputTuple,
    PriceHashSubmittedEvent.OutputObject
  >;
  getEvent(
    key: "PriceRevealed"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "PriceHashSubmitted(address,uint256,bytes32,uint256)": TypedContractEvent<
      PriceHashSubmittedEvent.InputTuple,
      PriceHashSubmittedEvent.OutputTuple,
      PriceHashSubmittedEvent.OutputObject
    >;
    PriceHashSubmitted: TypedContractEvent<
      PriceHashSubmittedEvent.InputTuple,
      PriceHashSubmittedEvent.OutputTuple,
      PriceHashSubmittedEvent.OutputObject
    >;

    "PriceRevealed(address,uint256,uint256,uint256,uint256,uint256,uint256)": TypedContractEvent<
      PriceRevealedEvent.InputTuple,
      PriceRevealedEvent.OutputTuple,
      PriceRevealedEvent.OutputObject
    >;
