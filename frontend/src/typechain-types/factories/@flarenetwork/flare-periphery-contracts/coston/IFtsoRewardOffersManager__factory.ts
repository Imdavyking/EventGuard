...
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IFtsoRewardOffersManager";
...
export class IFtsoRewardOffersManager__factory {
  ...
  static createInterface(): IFtsoRewardOffersManagerInterface {
    return new Interface(_abi) as IFtsoRewardOffersManagerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IFtsoRewardOffersManager;
  }
}
