...
import type {
  IRelay,
  IRelayInterface,
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IRelay";
...
export class IRelay__factory {
  ...
  static createInterface(): IRelayInterface {
    return new Interface(_abi) as IRelayInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IRelay {
    return new Contract(address, _abi, runner) as unknown as IRelay;
  }
}
