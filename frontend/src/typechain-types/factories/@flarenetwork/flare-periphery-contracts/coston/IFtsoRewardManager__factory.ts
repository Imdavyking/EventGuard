...
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IFtsoRewardManager";
...
export class IFtsoRewardManager__factory {
  ...
  static createInterface(): IFtsoRewardManagerInterface {
    return new Interface(_abi) as IFtsoRewardManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IFtsoRewardManager {
    return new Contract(address, _abi, runner) as unknown as IFtsoRewardManager;
  }
}
