...
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IFtsoManager";
...
export class IFtsoManager__factory {
  ...
  static createInterface(): IFtsoManagerInterface {
    return new Interface(_abi) as IFtsoManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IFtsoManager {
    return new Contract(address, _abi, runner) as unknown as IFtsoManager;
  }
}
