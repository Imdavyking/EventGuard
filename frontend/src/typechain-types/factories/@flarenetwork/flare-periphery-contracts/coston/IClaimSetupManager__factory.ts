...
} from "../../../../@flarenetwork/flare-periphery-contracts/coston/IClaimSetupManager";
...
export class IClaimSetupManager__factory {
  ...
  static createInterface(): IClaimSetupManagerInterface {
    return new Interface(_abi) as IClaimSetupManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IClaimSetupManager {
    return new Contract(address, _abi, runner) as unknown as IClaimSetupManager;
  }
}
