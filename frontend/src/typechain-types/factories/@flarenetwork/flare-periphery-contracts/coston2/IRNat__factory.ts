...
export class IRNat__factory {
  ...
  static createInterface(): IRNatInterface {
    return new Interface(_abi) as IRNatInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IRNat {
    return new Contract(address, _abi, runner) as unknown as IRNat;
  }
}
